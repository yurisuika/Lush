...
public class LushLeavesBlock extends Block {
    public static final int MAX_DISTANCE = 7;
    public static final IntProperty DISTANCE;
    public static final BooleanProperty PERSISTENT;
    private static final int field_31112 = 1;

    public LushLeavesBlock(Settings settings) {
        super(settings);
    ...
    private static int getDistanceFromLog(BlockState state) {
        if (state.isIn(BlockTags.LOGS)) {
            ...
            return state.getBlock() instanceof com.yurisuika.lush.block.LushLeavesBlock || state.getBlock() instanceof net.minecraft.block.LeavesBlock ? (Integer)state.get(DISTANCE) : 7;
        }
    }
